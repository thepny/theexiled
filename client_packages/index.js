...
setInterval(function () {
    var name = (localplayer.getVariable('REMOTE_ID') == undefined) ? `Not authorized` : `Player №${localplayer.getVariable("REMOTE_ID")}`;
...
mp.keys.bind(0x4B, false, function () {
	if (tabletCEF == null) {
		tabletCEF = mp.browsers.new('package://tablet/index.html');
		mp.gui.cursor.visible = true;
	} else if (tabletCEF != null) {
		tabletCEF.destroy();
		tabletCEF = null;
