...
var android = new Vue({
	...
	data: {
		...
		// gps
		gpsList: [
			// ["header", "Categories", 1, 0, 1, 0, false,[null]],
			// ["Гос.структуры", "Гос.структуры", 3, 0, 1, 0, false,[null]],
			// ["Works", "Works", 3, 0, 1, 0, false,[null]],
			// ["Gangs", "Gangs", 3, 0, 1, 0, false,[null]],
			// ["Mafia", "Mafia", 3, 0, 1, 0, false,[null]],
			// ["Nearest Places", "Nearest Places", 3, 0, 1, 0, false,[null]],
			// ["close", "Close", 3, 0, 1, 0, false,[null]],
		],

		// weazel_news
		weazelNewsList: [
			{title: 'Sell auto Sandking', price: '400.000', phone: '6445939'},
			{title: 'Sell auto Sandking', price: '400.000', phone: '6445939'},
			{title: 'Sell auto Sandking', price: '400.000', phone: '6445939'},
			{title: 'Sell auto Sandking', price: '400.000', phone: '6445939'},
			{title: 'Sell auto Sandking', price: '400.000', phone: '6445939'},
	...
	computed: {
		...
		statusCall() {
			...
			let time = min+':'+sec;
			return this.isCallOn ? 'Call duration ' + time : (
				this.isState('callIn') ? 'Incoming call' : 'Iconal call'
			);
		}
	}
});
