...
const houseClasses = [
  hclass(0, "Трейлер", 0),
  hclass(1, "Econom", "Nishchebward houses", 1),
  hclass(2, "Ranch+", "Well, so yourself", 2),
  hclass(3, "Premium", "Already not bad", 4),
  hclass(4, "Cottage", "And you moveя", 5),
  hclass(5, "Mansion", "Wow", 6),
  hclass(6, "Villa", "Luxury Villa, and you are rich", 8),
]
