...
spmenu.Close();
spmenu.AddItem(new UIMenuListItem("Spectate", "Switching player by ID",  new ItemsCollection(["Previous", "Next"])));
spmenu.AddItem(new UIMenuItem("Refresh", "Refresh tracking the current player"));
spmenu.AddItem(new UIMenuItem("Unspectate", "Turn off the observer mode"));
