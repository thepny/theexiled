...
var editing_types = ["Position by x", "Position on y", "Height", "Slope by x", "Slope on y", "Turn"];
...
mp.events.add('render', () => {
    if (object !== null) {
        ...
        AddInstructionalButton("Object management", 194);
        AddInstructionalButton("Object management", 195);
        AddInstructionalButtonCustom("Increase a speed", "t_+");
        AddInstructionalButtonCustom("Reduce speed", "t_-");
        AddInstructionalButtonCustom("Set", "t_Y");
