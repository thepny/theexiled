...
namespace Redage.SDK
{
    public static class Timers
    {
        ...
        /// <summary>
        /// Findet das Timer-Objekt und gibt es zurück
        /// </summary>
        /// <param name="id">Einzige Zeitgeber-ID</param>
        /// <returns>Timer-Objekt</returns>
        ...
        /// <summary>
        /// Start() startet den Timer und gibt eine zufällige ID zurück
        /// </summary>
        /// <param name="interval">Intervall zum Auslösen der Aktion</param>
        /// <param name="action">Lambda-Ausdruck mit Aktion</param>
        /// <returns>Einzige Zeitgeber-ID</returns>
        ...
        /// <summary>
        /// Start() startet den Timer mit einer eindeutigen ID
        /// </summary>
        /// <Ausnahme>
        /// Eine Ausnahme tritt auf, wenn eine vorhandene ID übergeben wird oder wenn sie null ist.
        /// </exception>
        /// <param name="id">Einzige Zeitgeber-ID</param>
        /// <param name="interval">Intervall der Aktion</param>
        /// <param name="action">Lambda-Ausdruck mit Aktion</param>
        /// <returns>Einzige Zeitgeber-ID</returns>
        ...
        /// <summary>
        /// StartOnce() startet den Timer einmal und gibt eine zufällige ID zurück
        /// </summary>
        /// <param name="interval">Intervall zum Auslösen der Aktion</param>
        /// <param name="action">Lambda-Ausdruck mit Aktion</param>
        /// <returns>Einzige Zeitgeber-ID</returns>
        ...
        /// <summary>
        /// StartOnce() startet den Timer einmal und gibt die ID zurück
        /// </summary>
        /// <Ausnahme>
        /// Eine Ausnahme tritt auf, wenn der Zeitgeber eine vorhandene ID oder null übergibt.
        /// </exception>
        /// <param name="id">Einzige Zeitgeber-ID</param>
        /// <param name="interval">Intervall der Aktion</param>
        /// <param name="action">Lambda-Ausdruck mit Aktion</param>
        ...
        /// <summary>
        /// StartTask() startet den Timer mit einer separaten Aufgabe und gibt eine zufällige ID zurück
        /// </summary>
        /// <param name="interval">Intervall zum Auslösen der Aktion</param>
        /// <param name="action">Lambda-Ausdruck mit Aktion</param>
        /// <returns>Einzige Zeitgeber-ID</returns>
        ...
        /// <summary>
        /// StartTask() startet den Timer mit einer separaten Aufgabe und gibt die ID zurück
        /// </summary>
        /// <Ausnahme>
        /// Eine Ausnahme tritt auf, wenn entweder die vorhandene ID übergeben wird oder der Wert null ist.
        /// </exception>
        /// <param name="id">Eigene ID für den Timer</param>
        /// <param name="interval">Intervall der Aktion</param>
        /// <param name="action">Lambda-Ausdruck mit Aktion</param>
        /// <returns>Einzige Zeitgeber-ID</returns>
        ...
        /// <summary>
        /// StartOnceTask() startet den Timer einmal mit einer separaten Aufgabe und gibt eine zufällige ID zurück
        /// </summary>
        /// <param name="interval">Intervall zum Auslösen der Aktion</param>
        /// <param name="action">Lambda-Ausdruck mit Aktion</param>
        /// <returns>Einzige Zeitgeber-ID</returns>
        ...
        /// <summary>
        /// StartOnceTask() startet den Timer einmal als separate Aufgabe und gibt die ID zurück
        /// </summary>
        /// <Ausnahme>
        /// Eine Ausnahme tritt auf, wenn entweder die vorhandene ID übergeben wird oder der Wert null ist.
        /// </exception>
