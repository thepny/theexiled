                            ...
                            else
                            {
                                ...
                                NAPI.Task.Run(() =>
                                {
                                    try
                                    {
                                        ...
                                        Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, $"You came {reds} Redbucks", 3000);
        ...
        public void wheelAdd(Player client, int id, bool add)
        {
            ...
            switch (id)
            {
                case 0:
                    ...
                    Log.Write("Money came in size 50 000", nLog.Type.Success);
                    break;
                case 1:
                    MoneySystem.Wallet.Change(client, 100000);
                    Log.Write("Money came in size 100 000", nLog.Type.Success);
                    break;
                case 2:
                    MoneySystem.Wallet.Change(client, 150000);
                    Log.Write("Money came in size 150 000", nLog.Type.Success);
                    break;
                case 3:
                    if (add)
                    {
                ...
                case 11:
                    ...
                    Log.Write("Money came in size 200 000", nLog.Type.Success);
                    break;
                case 12:
                    MoneySystem.Wallet.Change(client, 250000);
                    Log.Write("Money came in size 250 000", nLog.Type.Success);
                    break;
                case 13:
                    MoneySystem.Wallet.Change(client, 300000);
                    Log.Write("Money came in size 300 000", nLog.Type.Success);
                    break;
                case 14:
                    MoneySystem.Wallet.Change(client, 350000);
                    Log.Write("Money came in size 350 000", nLog.Type.Success);
                    break;
                case 15:
                    MoneySystem.Wallet.Change(client, 400000);
                    Log.Write("Money came in size 400 000", nLog.Type.Success);
                    break;
                case 16:
                    MoneySystem.Wallet.Change(client, 450000);
                    Log.Write("Money came in size 450 000", nLog.Type.Success);
                    break;
                case 17:
                    MoneySystem.Wallet.Change(client, 500000);
                    Log.Write("Money came in size 500 000", nLog.Type.Success);
                    break;
                    ...
                    case Type.GiveBox:
                        {
                            ...
                            {
                                Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, "An error has arisen, take up again", 3000);
                                return;
                            }
                            amount = Math.Abs(amount);
                            if (amount <= 0)
                            {
                                Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, "Enter the amount equal to 1 or more.", 3000);
                                return;
                            }
                            ...
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, $"You bought {amount} boxes!", 3000);
                    ...
                    case Type.Nickname:
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, "You did not indicate the name!", 3000);
                                    return;
                                }
                                else if (split[1] == "null" || string.IsNullOrEmpty(split[1]))
                                {
                                    Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, "You did not indicate the last name!", 3000);
                                    return;
                                }
                            }
                            catch (Exception e)
                            ...
                            else
                            {
                                ...
                                NAPI.Player.KickPlayer(target, "Change Nika");
                            }
                    ...
                    case Type.Convert:
                        {
                            ...
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully translated RF for {amount}", 3000);
                    ...
                    case Type.BronzeVIP:
                        {
                            ...
                            {
                                Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, "You have already purchased VIP status!", 3000);
                                return;
                            }
                            if (acc.RedBucks < 300)
                            {
                    ...
                    case Type.Warn:
                        {
                            ...
                            {
                                Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, "You do not have Warn'a!", 3000);
                                return;
                            }
                            if (acc.RedBucks < 250)
                            {
                    ...
                    case Type.Slot:
                        {
                            ...
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully transferred bought additional. character slot!", 3000);
                            return;
                        }
                    case Type.Money1:
                        {
                            ...
                            MoneySystem.Wallet.Change(client, 100000);
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully acquired $100 000", 3000);
                            Dashboard.sendStats(client);
                            break;
                        }
                    case Type.Money2:
                        {
                            ...
                            GameLog.Money(acc.Login, "server", 2500, "donateMoney");
                            MoneySystem.Wallet.Change(client, 300000);
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully acquired $300 000", 3000);
                            Dashboard.sendStats(client);
                            break;
                        }
                    case Type.Money3:
                        {
                            ...
                            GameLog.Money(acc.Login, "server", 2500, "donateMoney");
                            MoneySystem.Wallet.Change(client, 500000);
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully acquired $500 000", 3000);
                            Dashboard.sendStats(client);
                            break;
                        }
                    case Type.Money4:
                        {
                            ...
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully acquired $1 000 000", 3000);
                            Dashboard.sendStats(client);
                            break;
                        }
                    case Type.Box1:
                        {
                            ...
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully acquired Start for start set", 3000);
                            Dashboard.sendStats(client);
                            break;
                        }
                    case Type.Box2:
                        {
                            ...
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully purchased solid set", 3000);
                            Dashboard.sendStats(client);
                            break;
                        }
                    case Type.Box3:
                    ...
                    case Type.Box4:
                        {
                            ...
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully acquired gold reserves set", 3000);
                            Dashboard.sendStats(client);
                            break;
                        }
                    case Type.Lic1:
                        {
                            ...
                            {
                                Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, $"You already have an easy license", 3000);
                                return;
                            }
                            ...
                            GameLog.Money(acc.Login, "server", 500, "donateBox1");
                            Main.Players[client].Licenses[1] = true;
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully acquired a passenger license.", 3000);
                            Dashboard.sendStats(client);
                            break;
                        }
                    case Type.Lic2:
                        {
                            ...
                            if (Main.Players[client].Licenses[2])
                            {
                                Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, $"You already have a cargo license", 3000);
                                return;
                            }
                            ...
                            Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully purchased a truck license.", 3000);
                            Dashboard.sendStats(client);
                            break;
                        }
                }
