    ...
    class GarbageTruck : Script
    {
        ...
        public void Event_GarbageWorkStart()
        {
            try
            {
                ...
                NAPI.Blip.CreateBlip(318, new Vector3(-430.45914, -1726.7654, 17.803528), 1, 2, "The work of the garrower", 255, 0, true, 0, 0);
                NAPI.TextLabel.CreateTextLabel("~g~Garbage man", new Vector3(-430.45914, -1726.7654, 20.1), 10f, 0.1f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
        ...
        {
            player.SendNotification("You received " + amount + " For the assembled garbage!");
