...
namespace NeptuneEvo.Jobs
{
    class Construction : Script
    {
        ...
        public void Event_ResourceStart()
        {
            try
            {
                NAPI.Blip.CreateBlip(566, new Vector3(145.0445, -373.0724, 42.54742), 1, 46, Main.StringToU16("Builder"), 255, 0, true, 0, 0); // Блип на карте
        ...
        public static void Layoff2(Player player)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Turn in the box before you finish your work day", 3000);
                return;
            }
