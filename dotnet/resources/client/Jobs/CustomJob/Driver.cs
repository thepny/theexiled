...
namespace NeptuneEvo.Jobs
{
    class Diver : Script
    {
        ...
        public void Event_ResourceStart()
        {
            try
            {
                NAPI.Blip.CreateBlip(729, new Vector3(1695.163, 42.85501, 160.6473), 1.5f, 46, Main.StringToU16("Diver"), 255, 0, true, 0, 0); // Блип на карте
        ...
        public static void JobJoin(Player player)
        {
            ...
            //Dashboard.sendStats(player);
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You got a job", 3000);
            var jobsid = Main.Players[player].WorkID;
            Trigger.ClientEvent(player, "secusejobDiver", jobsid);
            return;
        }
        ...
        public static void JobJoin2(Player player, int job)
        {
            ...
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You have started your working day! Garbage spots are marked on the map. Pick up this garbage.", 3000);
