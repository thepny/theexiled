    ...
    class Dashboard : Script
    {
                ...
                switch (type)
                {
                    case 0:
                        {// self inventory
                            ...
                            {//remove one item from player inventory
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "The ability to upload the canisters is temporarily disabled", 3000);
                                    return;
                                }
                                ...
                                else if (nInventory.ClothesItems.Contains(item.Type))
                                {
                                    if (item.IsActive)
                                    {
                                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "You must first remove this clothes.", 3000);
                                        return;
                                    }
                                ...
                                else if (nInventory.WeaponsItems.Contains(item.Type) || nInventory.MeleeWeaponsItems.Contains(item.Type) || item.Type == ItemType.StunGun)
                                {
                                    if (item.IsActive)
                                    {
                                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "You must remove weapons from hand", 3000);
                                        return;
                                    }
                                    items.RemoveAt(index);
                                    Items.onDrop(player, new nItem(item.Type, 1, item.Data), null);
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "You can not throw things while in the car", 3000);
                                    return;
                                }
                                if (item.Count > 1)
                                {
                                    ...
                                    Trigger.ClientEvent(player, "openInput", "Throw out object", "Enter the number", 3, "item_drop");
                                    return;
                                }
                            ...
                            else if (data == "use")
                            {
                                try
                                {
                                    ...
                                    {
                                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "To use things, you need to close the exchange of things", 3000);
                                        return;
                                    }
                                    ...
                                    case 2:
                                        {
                                            ...
                                            if (item.Count > 1)
                                            {
                                                ...
                                                player.SetData("ITEMTYPE", item.Type);
                                                player.SetData("ITEMINDEX", index);
                                                Trigger.ClientEvent(player, "openInput", "Transfer the subject", "Enter the number", 3, "item_transfer_toveh");
                                                return;
                                            }
                                    ...
                                    case 3:
                                        {
                                            ...
                                            {
                                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "This thing is not intended for this cabinet.", 3000);
                                                return;
                                            }
                                            ...
                                            if (item.Count > 1)
                                            {
                                                ...
                                                player.SetData("ITEMTYPE", item.Type);
                                                player.SetData("ITEMINDEX", index);
                                                Trigger.ClientEvent(player, "openInput", "Transfer the subject", "Enter the number", 3, "item_transfer_tosafe");
                                                return;
                                            }
                                    ...
                                    case 4:
                                        {
                                            ...
                                            {
                                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Wardrobe can only store clothes", 3000);
                                                return;
                                            }
                                            if (Main.Players[player].InsideHouseID == -1) return;
                                            int houseID = Main.Players[player].InsideHouseID;
                                    ...
                                    case 5:
                                        {
                                            ...
                                            if (item.Count > 1)
                                            {
                                                ...
                                                player.SetData("ITEMTYPE", item.Type);
                                                player.SetData("ITEMINDEX", index);
                                                Trigger.ClientEvent(player, "openInput", "Convey subject", "Enter the number", 3, "item_transfer_toplayer");
                                                return;
                                            }
                                    ...
                                    case 6:
                                        {
                                            ...
                                            {
                                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "In stock is not enough", 3000);
                                                return;
                                            }
                                            ...
                                            if (item.Count > 1)
                                            {
                                                ...
                                                player.SetData("ITEMTYPE", item.Type);
                                                player.SetData("ITEMINDEX", index);
                                                Trigger.ClientEvent(player, "openInput", "Convey subject", "Enter the number", 3, "item_transfer_tofracstock");
                                                return;
                                            }
                                    ...
                                    case 7:
                                        {
                                            ...
                                            {
                                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Applicable keys only", 3000);
                                                return;
                                            }
                    ...
                    case 2:
                        { // in car items
                            ...
                            if (item.Count > 1)
                            {
                                ...
                                player.SetData("ITEMTYPE", item.Type);
                                player.SetData("ITEMINDEX", index);
                                Trigger.ClientEvent(player, "openInput", "Take object", "Enter the number", 3, "item_transfer_fromveh");
                                return;
                            }
                    ...
                    case 3: // Взять
                        {
                            ...
                            if (item.Count > 1)
                            {
                                ...
                                player.SetData("ITEMTYPE", item.Type);
                                player.SetData("ITEMINDEX", index);
                                Trigger.ClientEvent(player, "openInput", "Take object", "Enter the number", 3, "item_transfer_fromsafe");
                                return;
                            }
                    ...
                    case 6:
                        {
                            ...
                            if (item.Count > 1)
                            {
                                ...
                                player.SetData("ITEMTYPE", item.Type);
                                player.SetData("ITEMINDEX", index);
                                Trigger.ClientEvent(player, "openInput", "Take object", "Enter the number", 3, "item_transfer_fromfracstock");
                                return;
                            }
                    ...
                    case 7:
                        { // keyring items
                            ...
                            if (tryAdd == -1 || tryAdd > 0)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "You are not enough space", 3000);
                                return;
                            }
                    ...
                    case 20:
                        {
                            if (Main.Players[player].AdminLVL >= 6 && Main.Players[player].InsideHouseID == -1)
                            {
                                ...
                                if (nInventory.ClothesItems.Contains(item.Type) && item.IsActive == true)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "The player must remove this clothes.", 3000);
                                    return;
                                }
                                else if ((nInventory.WeaponsItems.Contains(item.Type) || nInventory.MeleeWeaponsItems.Contains(item.Type)) && item.IsActive == true)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "The player must remove this weapon from hand", 3000);
                                    return;
                                }
                                ...
                                if (item.Count > 1)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Such things can not pick up", 3000);
                                    return;
                                }
                                nInventory.Add(player, item);
        ...
        public static Task SendStatsAsync(Player player)
        {
            try
            {
                ...
                string work = acc.WorkID > 0 ? Jobs.WorkManager.JobStats[acc.WorkID - 1] : "Absent";
                string fraction = acc.FractionID > 0 ? Fractions.Manager.FractionNames[acc.FractionID] : "Absent";
