    ...
    class AlcoFabrication : Script
    {
        ...
        */
        ...
        public void Event_ResourceStart()
        {
            try
            {
                ...
                foreach (var pair in BuyPoints)
                {
                    ...
                    NAPI.Marker.CreateMarker(1, pair.Value - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(0, 255, 255), false, NAPI.GlobalDimension);
                    NAPI.TextLabel.CreateTextLabel($"~g~Buy / control alcohol", pair.Value + new Vector3(0, 0, 0.5), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                }
                #endregion
            }
        ...
        public static void Event_InteractPressed(Player player, int id)
        {
            switch (id)
            {
                ...
                case 56:
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Warehouse is filled", 3000);
                        return;
                    }
            ...
            try
            {
                ...
                switch (action)
                {
                    ...
                    case 2: // craft
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"In stock not enough materials", 3000);
                            return;
                        }
                        ...
                        return;
                    case 3: // setprice
                        Trigger.ClientEvent(player, "openInput", "Set the price", "Enter the price for alcohol in percent", 3, "club_setprice");
                        return;
                }
            }
        ...
        public static void SetAlcoholPrice(Player player, int price)
        {
            ...
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You changed the price of alcohol products to {price}%", 3000);
        }
        #endregion
