    ...
    class Merryweather : Script
    {
        ...
        public void OnResourceStartHandler()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~g~Press E. To enter the bunker"), new Vector3(Coords[0].X, Coords[0].Y, Coords[0].Z + 0.7), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~g~Press E. To get out of the bunker"), new Vector3(Coords[1].X, Coords[1].Y, Coords[1].Z + 0.7), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~g~Press E. To open the menu"), new Vector3(Coords[2].X, Coords[2].Y, Coords[2].Z + 1.8), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~g~Open warehouse"), new Vector3(Coords[3].X, Coords[3].Y, Coords[3].Z + 1.8), 5F, 0.3F, 0, new Color(250, 250, 250));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~g~Change clothes"), new Vector3(Coords[4].X, Coords[4].Y, Coords[4].Z + 1.8), 5F, 0.3F, 0, new Color(250, 250, 250));
        ...
        public static void interactPressed(Player player, int interact)
        {
            switch (interact)
            {
                ...
                case 85:
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "You are not a member Merryweather", 3000);
                        return;
                    }
                ...
                case 106:
                    ...
                    GUI.Dashboard.OpenOut(player, Stocks.fracStocks[17].Weapons, "Armory", 6);
                    return;
                case 107:
                    if (Main.Players[player].FractionID != 17)
                    {
        ...
        private static void callback_merycombat(Player client, Menu menu, Menu.Item item, string eventName, dynamic data)
        {
            ...
            {
                Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, $"You are not a member of MerryWeather", 3000);
                return;
            }
            if (!client.GetData<bool>("ON_DUTY"))
            {
