...
namespace NeptuneEvo
{
    public class CarMarket : Script
    {
        ...
        {
            NAPI.Blip.CreateBlip(490, new Vector3(-601.0428, -2228.1235, 4.9709), 1.7f, 0, Main.StringToU16("Car market"), 255, 0, true, 0, 0); // Блип на карте
            API.Shared.CreateTextLabel("~h~~g~- ~y~Car market~g~ -~w~~n~~n~FAQ (Press Е)", new Vector3(-601.0428, -2228.1235, 5.9709 + 0.6f), 20.0f, 3f, 4, new Color(255, 255, 255, 255), false, 0);
