...
namespace NeptuneEvo.Core
{
    class GanGame : Script
    {
        ...
        public void onResourceStart()
        {
            try
                {
                    Blip portblip = NAPI.Blip.CreateBlip(313, gangameCheckpoints[0], 0.91f, 5, Main.StringToU16("Arena (GunGame)"), 254, 0, true, 0, 0);
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("Nies is What to enter the arena"), new Vector3(gangameCheckpoints[0].X, gangameCheckpoints[0].Y, gangameCheckpoints[0].Z + 1.5), 20F, 0.5F, 0, new Color(255, 255, 255));
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("Nies is What to get out of the arena"), new Vector3(gangameCheckpoints[1].X, gangameCheckpoints[1].Y, gangameCheckpoints[1].Z + 1.5), 20F, 0.5F, 0, new Color(255, 255, 255));
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("Revolver \n ~o~Cost 50.000$"), new Vector3(gangameCheckpoints[2].X, gangameCheckpoints[2].Y, gangameCheckpoints[2].Z + 0.5), 20F, 0.5F, 0, new Color(255, 255, 255));
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("Assault Rifle \n ~o~Cost 65.000$"), new Vector3(gangameCheckpoints[3].X, gangameCheckpoints[3].Y, gangameCheckpoints[3].Z + 0.5), 20F, 0.5F, 0, new Color(255, 255, 255));
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("Combat PDW \n ~o~Cost 45.000$"), new Vector3(gangameCheckpoints[4].X, gangameCheckpoints[4].Y, gangameCheckpoints[4].Z + 0.5), 20F, 0.5F, 0, new Color(255, 255, 255));
        ...
        public static void interactPressed(Player player, int interact)
        {
            switch (interact)
            {
                ...
                case 146:
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You connected to the game.", 3000);
                    player.SendChatMessage($"Arus ~g~ Revolver.");
                    player.SendChatMessage($"What to return to the menu, use the command ~g~ /arena.");
                    return;
                case 147:
                    if (player.IsInVehicle) return;
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You connected to the game.", 3000);
                    player.SendChatMessage($"Arus ~g~ Assault Rifle.");
                    player.SendChatMessage($"What to return to the menu, use the command ~g~ /arena.");
                    return;
                case 148:
                    if (player.IsInVehicle) return;
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You connected to the game.", 3000);
                    player.SendChatMessage($"Arus ~g~ Combat PDW.");
                    player.SendChatMessage($"What to return to the menu, use the command ~g~ /arena.");
                    return;
            }
        }
