        ...
        public void Event_OnPlayerExitVehicle(Player player, Vehicle vehicle)
        {
            try
            {
                if (player.HasData("SCHOOLVEH") && player.GetData<Vehicle>("SCHOOLVEH") == vehicle)
                {
                    ...
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, $"If you do not sit in the car for 60 seconds, then fail the exam", 3000);
                    return;
                }
            }
        ...
        private void timer_exitVehicle(Player player)
        {
            NAPI.Task.Run(() =>
            {
                try
                {
                    ...
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, $"You failed the exam", 3000);
                }
        ...
        public static void startDrivingCourse(Player player, int index)
        {
            ...
            switch (index)
            {
                case 0:
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You do not have enough money to buy this license.", 3000);
                        return;
                    }
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"To start transport, press B key", 3000);
                    return;
                case 1:
                    ...
                    Core.VehicleStreaming.SetEngineState(vehicle, false);
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"To start transport, press B", 3000);
                    return;
                case 2:
                ...
                case 3:
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Have you successfully bought a license for water transport", 3000);
                ...
                case 4:
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You have successfully bought licensed helicopters management", 3000);
                    Dashboard.sendStats(player);
                    return;
                case 5:
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You have successfully bought licensed aircraft management", 3000);
                    Dashboard.sendStats(player);
                    return;
            }
        }
        ...
        private void onPlayerEnterDrive(ColShape shape, Player player)
        {
            try
            {
                ...
                if (check == drivingCoords.Count - 1)
                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You successfully passed the exam", 3000);
                    Dashboard.sendStats(player);
                    Trigger.ClientEvent(player, "deleteCheckpoint", 12, 0);
                    return;
                }
