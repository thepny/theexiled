            ...
            try
            {
                switch (id)
                {
                    case 40:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "You can not enter the garage on this car", 3000);
                            return;
                        }
                        ...
                        if (garage.Type == -1)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Your car is now somewhere in the state, you can evacuate her", 3000);
                                return;
                            }
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "You must restore the car", 3000);
                                return;
                            }
